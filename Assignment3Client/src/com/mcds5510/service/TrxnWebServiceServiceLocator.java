...
public class TrxnWebServiceServiceLocator extends org.apache.axis.client.Service implements com.mcds5510.service.TrxnWebServiceService {
    ...
    public com.mcds5510.service.TrxnWebService getTrxnWebService() throws javax.xml.rpc.ServiceException {
    ...
    public com.mcds5510.service.TrxnWebService getTrxnWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.mcds5510.service.TrxnWebServiceSoapBindingStub _stub = new com.mcds5510.service.TrxnWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.mcds5510.service.TrxnWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.mcds5510.service.TrxnWebServiceSoapBindingStub _stub = new com.mcds5510.service.TrxnWebServiceSoapBindingStub(new java.net.URL(TrxnWebService_address), this);
                _stub.setPortName(getTrxnWebServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.mcds5510.com", "TrxnWebServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.mcds5510.com", "TrxnWebService"));
        }
